	...
	},
	{
		...
		config = function()
			...
			local function getGreeting(name)
				...
				local greetingIndex = (hour < 7 and 1)
					or (hour < 12 and 2)
					or (hour < 18 and 3)
					or (hour < 21 and 4)
					or 5
			...
			local function button(sc, txt, keybind)
				return {
					...
					val = txt,
					on_press = function()
						vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes(sc, true, false, true), "normal", false)
					end,
					opts = {
						position = "center",
						text = txt,
